"""
Simple DuckDuckGo-based web search for OpenClaw.

Usage (installed): simple-search "query" [max_results]
Outputs JSON to stdout with engine and results (title, url, snippet).
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: simple-search \"query\" [max_results]", file=sys.stderr)
        sys.exit(1)
